...
public enum CRCArmorMaterials implements ArmorMaterial {
    ...
    RAINBOW("rainbow", 48, new int[]{4, 7, 9, 4}, 25, SoundEvents.ARMOR_EQUIP_NETHERITE, 4.0F, 0.1F,
    ...
    private CRCArmorMaterials(String pName, int pDurabilityMultiplier, int[] pSlotProtections, int pEnchantmentValue, SoundEvent pSound, float pToughness, float pKnockbackResistance, Supplier<Ingredient> pRepairIngredient) {
        this.name = pName;
